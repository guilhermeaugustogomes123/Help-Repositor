...
import { Bell, RefreshCw, Package, TrendingDown, AlertTriangle, CheckCircle, Layers, BoxIcon, History, ChevronRight, Clock } from 'lucide-react'
import { useApp } from '../store/AppContext'
import { TopBar } from '../components/Nav'

export default function Dashboard() {
  const { products, alerts, replenishment, history } = useApp()
